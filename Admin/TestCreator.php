...
<script>
    $(document).ready(function(){
        ...
        $("#submit").click(function(){
            ...
            var str3 = $("#a3").val();
            var str4 = $("#a4").val();
            var option1 = $('<option></option>').attr("value", str1).text("Text");
            $("#o1").append(option);
            var option2 = $('<option></option>').attr("value", str2).text("Text");
            $("#o2").append(option);
            var option3 = $('<option></option>').attr("value", str3).text("Text");
            $("#o3").append(option);
            var option4 = $('<option></option>').attr("value", str4).text("Text");
            $("#o4").append(option);
        });
    });
</script>
